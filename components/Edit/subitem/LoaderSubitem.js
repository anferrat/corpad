...
import { getCardDefaultName, getCircuitDefaultName, genValidObject, verifyTypes, genRequestObject } from '../../customFunctions'
...
const LoaderSubItem = (props) => {
    ...
    if (!data.uid)
        return <View style={androidStyle.EmptyCardList}><ActivityIndicator color={primary} /></View>
    else
