...
import { getSurveyInfo } from '../app/controllers/survey/other/SurveyInfoController'
import { saveSurvey } from '../app/controllers/survey/SurveyController'
...
export default DevScreen = ({ navigation, route }) => {
  ...
  const testBackend = async () => {
    const { errorMessage, status } = await saveSurvey()
