...
import { createItem, deleteItem, updateItem, getItemById, getItemDisplayData, getItemIdList, updateItemProperty } from '../app/controllers/survey/items/ItemController'
...
export default DevScreen = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView style={{ ...globalStyle.screen, paddingTop: StatusBar.currentHeight }}>
      ...
      <Button onPress={test1} appearance='ghost'>Share</Button>
    </SafeAreaView>
  )
}
