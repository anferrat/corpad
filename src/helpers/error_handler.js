...
const errorCodes = {
    ...
    428: 'Unable to read spreadsheet',
    ...
    439: 'Unable to open .xlsx file',
    440: 'File exeeds 3MB size limit',
    ...
    828: 'Unable to read external link',
    829: 'Unable to transfer data from external link',
    830: 'Unable to find items with given parameters in the survey.',
    831: 'Unable to find items with given coordinates',
    832: 'Unable to generate pipeline matching list',
    833: 'Data link is corrupted.',
    834: 'Generated link is too long.',
    835: 'Tag is not formatted as NDEF writable',
    836: 'Tag is locked to read only mode',
    837: "Tag doesn't have enough space.",
    838: 'Unable to write to NDEF tag',
    ...
    844: 'Unable to create QR-code xml string',
