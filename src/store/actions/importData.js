...
export const setImportData = (fields, data, fileName, defaultNames, path, potentialTypes, referenceCells, pipelines, autoCreatePotentials) =>
    ({ type: SET_IMPORT_DATA, fields: fields, data: data, fileName: fileName, defaultNames: defaultNames, path, potentialTypes, referenceCells, pipelines, autoCreatePotentials })
...
export const removePotential = (subitemIndex, potentialIndex) =>
    ({ type: REMOVE_IMPORT_SUBITEM_POTENTAIL, subitemIndex: subitemIndex, potentialIndex: potentialIndex })
