...
import { Pressable, Keyboard, StyleSheet, ActivityIndicator, View, FlatList } from 'react-native'
...
import { subtitleHandlerItem, iconHandlerItem } from '../../helpers/functions'
...
const SearchBar = (props) => {
    ...
    const renderItem = React.useCallback(({ item }) =>
        <ListItemSearch
            ...
            onPress={props.navigateToItemView.bind(this, item.id, item.dataType)} />,
        [props.navigateToItemView])
